...
namespace UnityEditor
{
	internal class SpriteUtilityWindow : EditorWindow
	{
		...
		protected void DoAlphaZoomToolbarGUI()
		{
			...
			this.m_Zoom = GUILayout.HorizontalSlider(this.m_Zoom, this.GetMinZoom(), 10f, SpriteUtilityWindow.s_Styles.preSlider, SpriteUtilityWindow.s_Styles.preSliderThumb, new GUILayoutOption[]
			{
