...
namespace UnityEditor
{
	...
	internal class WindInspector : Editor
	{
		...
		{
			public static GUIContent Mode = EditorGUIUtility.TextContent("WindZone.Mode");
			public static GUIContent Radius = EditorGUIUtility.TextContent("WindZone.Radius");
			public static GUIContent WindMain = EditorGUIUtility.TextContent("WindZone.WindMain");
			public static GUIContent WindTurbulence = EditorGUIUtility.TextContent("WindZone.WindTurbulence");
			public static GUIContent WindPulseMagnitude = EditorGUIUtility.TextContent("WindZone.WindPulseMagnitude");
			public static GUIContent WindPulseFrequency = EditorGUIUtility.TextContent("WindZone.WindPulseFrequency");
		}
