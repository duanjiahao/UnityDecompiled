...
internal class MSVCCompiler : NativeCompiler
{
	...
	protected override void SetupProcessStartInfo(ProcessStartInfo startInfo)
	{
		...
		{
			string text = startInfo.EnvironmentVariables["PATH"];
			text = "C:\\Program Files (x86)\\Microsoft Visual Studio 10.0\\Common7\\IDE" + Path.PathSeparator + text;
			startInfo.EnvironmentVariables["PATH"] = text;
		}
	}
}
